...
/**
 * Model of an ProcessView object.
 * @author Tecnalia
 * @version 1.0
 */
@Entity
@Table(name = "v03_idesignres_processes")
public class ProcessView implements Serializable, Cloneable {
	
	/* The "serialVersionUID" constant */
	private static final long serialVersionUID = 2013895940023453845L;
    ...
    /** The results. */
    private transient Integer results;
    
    
    /**
     * Constructs a ProcessView.
     */
    public ProcessView() {
    	super();
     ...
     */
    public ProcessView(final String uuid, final String name, final String description,
    ...
    public void setResults(final Integer results) {
        this.results = results != null ? results : 0;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final ProcessView vo = (ProcessView) o;
    ...
    public String toString() {
    	StringBuffer buffer = new StringBuffer("ProcessView {");
    	...
    	buffer.append(", layers=").append(getLayers());
    	buffer.append(", results=").append(getResults()).append("}");
