...
def test_missingCommandLineParametersForProcess():
    ...
    try:
        parameters = ['pv_power_plants_py.py', '',
                      '2019-03-01T13:00:00', '2019-03-02T13:00:00']
        validator.validateCommandLineParameters(parameters)
    except Exception as e:
        exceptionsRaised += 1
    ...
    try:
        parameters = ['pv_power_plants_py', 'wrong_input.json',
                      '2019-03-01T13:00:00', '2019-03-02T13:00:00']
        validator.validateCommandLineParameters(parameters)
    except Exception as e:
        exceptionsRaised += 1
    ...
    try:
        parameters = ['pv_power_plants_py.py', TEST_INPUT_PATH,
...
def test_commandLineParametersOKForProcess():
    ...
    try:
        parameters = ['pv_power_plants_py', TEST_INPUT_PATH,
                      '2019-03-01T13:00:00', '2019-03-02T13:00:00']
        validator.validateCommandLineParameters(parameters)
    except Exception as e:
        exceptionsRaised += 1
